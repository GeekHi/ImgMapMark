		...
		this.publicMethods = {
			init: function (options) {
				...
				document.oncontextmenu = function (event) {
					if (event.target.className == "icon-01") {
			...
			mark: function (x, y, name, content) {
				...
				mContainer.append($('<div class="icon-01" id="mark_' + newMark.id + '"></div>'));
			...
			setAddState: function (flag) {
				map_canAddFlag = flag;
				mContainer.append($('<div class="icon-01" id="mark_temp" style="display:none"></div>'));
			}
		}
